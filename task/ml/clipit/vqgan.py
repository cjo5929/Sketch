...
from task.ml.clipit.DrawingInterface import DrawingInterface
...
from task.ml.taming_transformers.taming.models import cond_transformer, vqgan
...
class VqganDrawer(DrawingInterface):
    ...
    def load_model(self, config_path, checkpoint_path, device):
        ...
        if config_path is None:
            config_path = f'task/ml/models/vqgan_{self.vqgan_model}.yaml'

        if checkpoint_path is None:
            checkpoint_path = f'task/ml/models/vqgan_{self.vqgan_model}.ckpt'
