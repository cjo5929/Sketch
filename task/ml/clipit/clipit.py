...
from task.ml.clipit.vqgan import VqganDrawer
try:
...
def ascend_txt(args, cur_iteration):
    global cur_anim_index, perceptors, normalize, cutoutsTable, cutoutSizeTable
...
def train(args, cur_it):
    ...
    for i in range(args.batches):
        lossAll = ascend_txt(args, cur_it)
...
def setup_parser():
    ...
    vq_parser.add_argument("-o",    "--output", type=str, help="Output file", default="static/diary_img/output.png", dest='output')
