...
from diary.ml_models.KoBert.kobert.mxnet_kobert import get_mxnet_kobert_model
from diary.ml_models.KoBert.kobert.onnx_kobert import get_onnx_kobert_model
